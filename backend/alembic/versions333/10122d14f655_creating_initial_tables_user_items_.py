"""Creating initial tables: user + items + transactions

Revision ID: 10122d14f655
Revises: 
Create Date: 2025-12-12 14:06:54.399205
...
def upgrade() -> None:
    ...
    sa.Column('symbol', sqlmodel.sql.sqltypes.AutoString(length=99), nullable=False),
